...
export default function TaskFlowDashboard() {
  ...
  const PROJECT_TABS = ["Tasks", "Timeline", "Files", "Team"] as const;
    ...
    <div className="flex-1 mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pb-20 overflow-y-auto">
        {TEAM_MEMBERS.map((member) => (
          <div
            key={member.id}
            className="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm flex flex-col items-center relative hover:shadow-md transition-shadow"
          >
