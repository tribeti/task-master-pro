...
export default function ProfilePage() {
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    // AC3: Client-side confirm mismatch
    ...
    try {
      ...
      if (!res.ok) {
        // AC2: Server returns "Mật khẩu hiện tại không đúng"
        setPasswordError(data.error || "Đã xảy ra lỗi.");
        return;
      }
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100">
              ...
              <form onSubmit={handleChangePassword} className="space-y-4">
                {/* General password error (AC2) */}
                {passwordError && (
                  <div className="p-3.5 bg-red-50 text-red-600 text-sm font-medium rounded-2xl border border-red-100 flex items-center gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
