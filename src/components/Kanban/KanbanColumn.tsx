...
import { Task, KanbanTask as KanbanTaskType } from "@/types/project";
...
export function KanbanColumn({
  ...
  return (
    ...
    >
      {/* Column Header */}
      <h3
        className={`font-bold text-xs tracking-widest uppercase flex items-center justify-between px-2 ${st.text}`}
      >
        {colIndex > 0 ? (
      ...
      {/* Tasks */}
      <div className="flex flex-col gap-3 min-h-15">
        {tasks.length === 0 ? (
