                ...
                <div className="p-8 flex flex-col gap-5 overflow-y-auto w-full">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full text-slate-900 px-4 py-3 border border-slate-200 rounded-2xl text-sm font-medium focus:outline-none focus:border-[#28B8FA] transition-colors"
                            disabled={isSubmitting}
                        />
                    </div>
