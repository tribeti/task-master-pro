...
export function ChatTab({ projectId }: { projectId: number }) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#F8FAFC] rounded-3xl border border-slate-200 overflow-hidden shadow-sm">
      {/* Messages Area */}
      <div
            ...
            {hasMore && (
              <div className="flex justify-center mb-4">
                <button
                  ...
                  className="px-4 py-1.5 bg-white border border-slate-200 text-slate-500 text-xs font-bold rounded-full hover:bg-slate-50 transition-colors disabled:opacity-50"
                >
      ...
      {/* Typing Indicator */}
      <div className="h-6 bg-[#F8FAFC] px-6 flex items-center shrink-0">
